...
ipcMain.on("optimize_call", async (event,rooms, sensor_field_of_view, areas, ceiling_height, detection_height) => {
  ...
  console.log(k, "k ", rooms, "rooms test");
  ...
  // formData.append('shape', JSON.stringify([542, 800]));
  // formData.append('ceiling_height', ceiling_height;
  // formData.append('detection_height', detection_height);
  // formData.append('sensors_field_of_view', sensors_field_of_view);
